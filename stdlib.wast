...
(func $char_code (param $string i32) (param $pos i32) (result i32)
  ...
  (local $charlen i32)
  (local $mask i32)
  (set_local $pos (call $-chars_to_bytes
    (call $-offset (get_local $string))
    (call $-i32_u (get_local $pos))
  ))
  (set_local $charlen (call $-char_size (call $-read8 (get_local $string) (get_local $pos))))
  ...
  (block(loop (br_if 1 (i32.eqz (get_local $charlen)))
    ...
    (set_local $code (i32.add
      (get_local $code)
      (i32.and
        (call $-read8 (get_local $string) (get_local $pos))
        (get_local $mask)
      )
    ))
